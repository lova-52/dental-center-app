                                    ...
                                    (t) => {
                                      ...
                                      return (
                                        <span
                                          ...
                                          className="inline-flex max-w-full min-w-0 items-center gap-1.5 rounded-full border px-2 py-0.5 text-[11px] font-semibold"
                                          style={getTelesaleColorStyle(
                                            telesaleColor
                                          )}
                                        >
